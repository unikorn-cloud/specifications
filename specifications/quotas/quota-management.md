...
Quotas need to be &emdash; initially &emdash; targeted at what really matters to the business.
...
Asking for 10 machines &emdash; with 64 cores, 1TiB RAM and 4 GPUs &emdash; is a lot easier than having to figure out that to supply 40 GPUs, you also need 640 cores and 10TiB of RAM to actually fulfill that request.
...
If we take the nai&iuml;ve view that user A has a quota that takes up 50% of the system, and user B the other 50%, then you cannot schedule any more users on to your finite hardware footprint.
